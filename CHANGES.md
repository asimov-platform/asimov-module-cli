...
- Implement `asimov module install all`
...
- Add support for module dependency installation
- Accept `--version` and `--model-size` flags for `install` and `upgrade`

## 25.0.0-dev.11 - 2025-10-22

### Changed

- Enhance `asimov module config`. (#63 by @SamuelSarle)
